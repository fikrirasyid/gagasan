...
function gagasan_custom_header_setup() {
	add_theme_support( 'custom-header', apply_filters( 'gagasan_custom_header_args', array(
		...
		'admin-head-callback'    => 'gagasan_admin_header_style',
		'admin-preview-callback' => 'gagasan_admin_header_image',
	) ) );
}
...
if ( ! function_exists( 'gagasan_admin_header_style' ) ) :
/**
 * Styles the header image displayed on the Appearance > Header admin panel.
 *
 * @see gagasan_custom_header_setup().
 */
function gagasan_admin_header_style() {
?>
	<style type="text/css">
...
endif; // gagasan_admin_header_style

if ( ! function_exists( 'gagasan_admin_header_image' ) ) :
/**
 * Custom header image markup displayed on the Appearance > Header admin panel.
 *
 * @see gagasan_custom_header_setup().
 */
function gagasan_admin_header_image() {
...
endif; // gagasan_admin_header_image